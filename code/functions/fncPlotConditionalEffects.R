...
l <-  list(visreg::visreg2d(the_model, data = the_data, x = "cov.daylength_hours", y = "cov.antec_air_temp", plot.type = "gg",
...
# Figure 7
g1 <- list(
  visreg::visreg2d(the_model, data = the_data, x = "cov.air_temp_ws", y = "cov.antec_air_temp", plot.type = "gg",
  ...
  visreg::visreg2d(the_model, data = the_data, x = "cov.daylength_hours", y = "cov.antec_air_temp", plot.type = "gg",
    xlab = expression(italic("DL") * " (hours)"), ylab = expression(italic("Tl") * " (\u00B0C)")) +
    scale_fill_viridis_c(limits = c(0, 19), option = "magma") +
    geom_point(aes(cov.daylength_hours, cov.antec_air_temp), data = the_data, col = 'grey85', pch = ".") +
    geom_contour(aes(z = z), color = "grey40", binwidth = 1) + coord_cartesian(ylim = c(-10,28)) +
  ...
  visreg::visreg2d(the_model, data = the_data, x = "cov.std_mean_flow", y = "cov.antec_air_temp", plot.type = "gg",
  ...
  visreg::visreg2d(the_model, data = the_data, x = "cov.SWE_ws", y = "cov.air_temp_ws", plot.type = "gg",
  ...
  visreg::visreg2d(the_model, data = the_data, x = "cov.elev_mean_smo", y = "cov.antec_air_temp", plot.type = "gg",
  ...
  visreg::visreg2d(the_model, data = the_data, x = "cov.elev_diff", y = "cov.antec_air_temp", plot.type = "gg",
  ...
  visreg::visreg2d(the_model, data = the_data, x = "cov.area_km2_ws_log", y = "cov.antec_air_temp", plot.type = "gg",
  ...
  visreg::visreg2d(the_model, data = the_data, x = "cov.BFI_cat", y = "cov.antec_air_temp", plot.type = "gg",
  ...
  visreg::visreg2d(the_model, data = the_data, x = "cov.pct_for_all_cat_rip100m", y = "cov.antec_air_temp", plot.type = "gg",
  ...
  visreg::visreg2d(the_model, data = the_data, x = "cov.pct_ow_ws", y = "cov.antec_air_temp", plot.type = "gg",
  ...
  visreg::visreg2d(the_model, data = the_data, x = "tim.doy", y = "cov.SWE_1Apr", plot.type = "gg",
  ...
  visreg::visreg2d(the_model, data = the_data, x = "cov.elev_mean_smo", y = "cov.area_km2_ws_log", plot.type = "gg",
...
# Figure S3
g2 <- list(
  visreg::visreg2d(the_model, data = the_data, x = "cov.slope", y = "cov.antec_air_temp", plot.type = "gg",
  ...
  visreg::visreg2d(the_model, data = the_data, x = "cov.lat_v", y = "cov.antec_air_temp", plot.type = "gg",
  ...
  visreg::visreg2d(the_model, data = the_data, x = "cov.canopy_line", y = "cov.antec_air_temp", plot.type = "gg",
  ...
  visreg::visreg2d(the_model, data = the_data, x = "cov.pct_wet_all_ws", y = "cov.antec_air_temp", plot.type = "gg",
  ...
  visreg::visreg2d(the_model, data = the_data, x = "cov.pct_ice_ws", y = "cov.antec_air_temp", plot.type = "gg",
  ...
  visreg::visreg2d(the_model, data = the_data, x = "cov.pct_extru_vol_ws", y = "cov.antec_air_temp", plot.type = "gg",
  ...
  visreg::visreg2d(the_model, data = the_data, x = "cov.pct_urb_all_ws", y = "cov.antec_air_temp", plot.type = "gg",
  ...
  visreg::visreg2d(the_model, data = the_data, x = "cov.air_temp_range_cat", y = "cov.antec_air_temp", plot.type = "gg",
  ...
  visreg::visreg2d(the_model, data = the_data, x = "cov.precip_cat", y = "cov.antec_air_temp", plot.type = "gg",
